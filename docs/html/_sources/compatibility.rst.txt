...
- Action Commander / TinkerBoi addon will have a specific naming convention
- Example: B4_1_0_Action_Commander-1_2_0.zip
- The First Part B4_1_0 indicate the Official Supported Blender Version and the Blender Version the addon is developed on
- The Last Numbering 1_2_0 indicate the Version of the Addon

(Insert Graphic to Explain File Name Convention)
